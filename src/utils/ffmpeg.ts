...
export async function downloadFFmpeg(download_dir?: string | undefined) {
  const dir = download_dir || BIN_DIR;
...
export function findFFmpegBinary(download_dir?: string | undefined) {
  try {
    const dir = download_dir || BIN_DIR;
