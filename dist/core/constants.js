...
exports.VIDEO_INFO_FIELDS = void 0;
exports.buildVideoInfoPrintArg = buildVideoInfoPrintArg;
exports.buildBeforeDownloadPrintArg = buildBeforeDownloadPrintArg;
exports.getDownloadPrintArgs = getDownloadPrintArgs;
/**
...
function buildVideoInfoPrintArg() {
    const jsonFields = exports.VIDEO_INFO_FIELDS.map((field) => `"${field}":%(${field}|null)j`).join(',');
